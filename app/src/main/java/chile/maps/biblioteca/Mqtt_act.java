...
public class Mqtt_act extends AppCompatActivity {
    ...
    static String MQTTHOST = "tcp://tailor.cloudmqtt.com:13166";
    static String USERNAME = "fzxwhlsv";
    static String PASSWORD = "0B4m-6QHo7FH";
        ...
        try {
            ...
            token.setActionCallback(new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    // We are connected
                    Toast.makeText(getBaseContext(), "Conectado Correctamente", Toast.LENGTH_LONG).show();
                }

                @Override
                public void onFailure(IMqttToken asyncActionToken, Throwable exception) {
                    // Something went wrong e.g. connection timeout or firewall problems
                    Toast.makeText(getBaseContext(), "No se ha establecido conexión", Toast.LENGTH_LONG).show();
